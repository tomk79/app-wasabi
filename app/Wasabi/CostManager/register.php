<?php
namespace App\Wasabi\CostManager;

use App\User;
use App\Wasabi\CostManager\Models\WasabiappCostManagerPage;
...
class register{
	...
	public static function config(){
		return [
			'id' => 'CostManager',
			'name' => 'Cost Manager',
			'api' => 'App\\Wasabi\\CostManager\\register::api',
			'web' => 'App\\Wasabi\\CostManager\\register::web',
		];
	}
