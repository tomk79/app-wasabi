...
<div class="container">
	...
	<form action="{{ url('settings/projects/'.urlencode($project->id).'/members/'.urlencode($user->email)) }}" method="post">
		@csrf
		@method('PUT')
	...
	<div class="text-right">
		<a href="{{ url('settings/projects/'.urlencode($project->id).'/members/'.urlencode($user->email)) }}" class="btn btn-default">キャンセル</a>
	</div>
